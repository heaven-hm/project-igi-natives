...
- Expanded `assets/IGI_Structures.hpp` and `assets/IGINatives.json DataTypes` with task-type records, weapon-entity proven fields, QFile alias/device record strides, and the eight-word sound-event payload. Unknown bytes remain opaque or reserved.
