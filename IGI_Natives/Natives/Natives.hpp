...
namespace IGI {
	enum class HASH
	{
		...
		CUTSCENE_DELETE = 0x00415AB0, // retail name: Game_CutsceneDelete
		...
		INPUT_ENABLE = 0x00415830, // retail name: Game_EnablePlayerInput
		LOG_ADD = 0x004BBC30,
		LEVEL_LOAD_OBJECTS = 0x004F0E10,	// corrected proc name: loads level objects
		LEVEL_LOAD = 0x004F0E10,	// SDK compatibility alias for level object loading
		GAME_DELETE_HANDLER = 0x00416550,	// corrected proc name: game-session delete/teardown handler
		LEVEL_QUIT = 0x00416550,	// SDK compatibility alias for the level delete/quit handler
		GAME_RESTART = 0x00416FE0,	// corrected proc name: restart current level/session
		LEVEL_RESTART = 0x00416FE0,	// SDK compatibility alias for game restart
		LEVEL_START = 0x00415B30,
		MAGIC_OBJ_LOAD = 0x004C4930,
		MENU_MANAGER = 0x00418B00,
		MUSIC_DISABLE = 0x00415A60, // retail name: Game_DisableMusic
		MUSIC_ENABLE = 0x00415A10, // retail name: Game_EnableMusic
		MUSIC_SFX_VOLUME = 0x00495F30,
		MUSIC_VOLUME = 0x00495E70,
		MUSIC_UPDATE_VOLUME = 0x004158E0, // retail name: Game_UpdateVolume
		PHYSICS_OBJ_TYPE_PARSE = 0x004EDFE0, // retail name: PhysicsObjType_ParseConfigFile
		...
		QVM_LOAD = 0x004B80B0,
		RESOURCE_FLUSH = 0x004B63D0, // retail name: Resource_Flush
		RESOURCE_LOAD = 0x004B5F00,
		RESOURCE_UNLOAD = 0x004B6380, // retail name: Resource_Unload
		RESOURCE_PACK_UNPACK = 0x004B18B0,
		RESOURCE_UNPACK = 0x004B16D0,
		RESOURCE_IS_LOADED = 0x004B5B90,
		SCRIPT_INIT = 0x004F0E50,
		SCRIPT_SETSYMBOL_CXT = 0x004B8930, // retail name: Script_SetSymbolContext
		STATUS_MESSAGE_CLEAR = 0x00485AD0, // retail name: StatusMessageScreen_ClearMessages
		...
		MEMORY_ALLOC = 0x004B0C60, // retail name: Mem_Alloc
		MEMORY_DEALLOC = 0x004B0BE0,
		MISSION_OPEN = 0x00484E60, // retail name: Mission_Open
		...
		WEAPON_ENTITY_CREATE = 0x00477C50,
		WEAPON_FIRING_STATE_GET = 0x00477C10,
		SOUND_EVENT_TRIGGER = 0x004E7200,
		STRING_VFORMAT = 0x004A5702,
		QFILE_ALIAS_RESOLVE = 0x004B1020,
		QFILE_DEVICE_INDEX = 0x004B11A0,
		QFILE_DEVICE_HANDLER_LOOKUP = 0x004B1620,
		PROFILE_VALUE_SET = 0x004B8A50,
